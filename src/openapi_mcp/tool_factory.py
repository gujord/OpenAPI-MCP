...
class ToolFunctionFactory:
    ...
    def create_tool_function(self, op_id: str, method: str, path: str, parameters: List[Dict[str, Any]]) -> Callable:
        ...
        def tool_function(req_id: Any = None, **kwargs):
            ...
            try:
                ...
                return self._execute_request(req_id, method, full_url, req_params, req_headers, req_body)
    ...
    def _execute_request(
        self, req_id: Any, method: str, url: str, params: Dict[str, Any], headers: Dict[str, str], body: Any
    ) -> Dict[str, Any]:
        """Execute HTTP request and return response."""
        try:
            with httpx.Client() as client:
                response = client.request(
                    method=method, url=url, params=params, headers=headers, json=body if body else None
                )
            ...
            return {"jsonrpc": "2.0", "id": req_id, "error": {"code": -32603, "message": error_msg}}
        except Exception as e:
